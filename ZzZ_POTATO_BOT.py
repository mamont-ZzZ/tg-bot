...
def start(message):
    ...
    markup.add(types.InlineKeyboardButton('НЕ УЧАСТВУЮ', callback_data='not_engage'))
    bot.send_message(message.chat.id, f'Привет {message.from_user.first_name}!\nГоворит бот-помощник Даниэля.\nУ меня для тебя системное уведомление:\n\n'
                                      ...
                                      'Ваш,\n'
                                      'Виртуальный организатор Даниэля <a href="https://avatars.mds.yandex.net/i?id=aa558d1a89352f190eda7a4fbc738f0a_sr-5194348-images-thumbs&n=13">🤖</a>\n', parse_mode='html', disable_web_page_preview=True, reply_markup=markup)

@bot.callback_query_handler(func=lambda call: True)
def callback(call):
    if call.data == 'not_engage':
        bot.send_message(call.message.chat.id, 'Пожалуйста свяжитесь с Даниэлем - @ABOBA_ZzZz')
